...
const text = {
  ...
  bn: {
    ...
    yourCart: "আপনার কার্ট", wishlistTitle: "Wishlist", couponCode: "কুপন কোড", couponEligibleNote: "কুপন শুধু Eligible পণ্যে কাজ করবে।", subtotal: "সাবটোটাল", discount: "ছাড়", delivery: "ডেলিভারি", total: "মোট", checkout: "Order now", orderConfirmLine: "অর্ডার confirm করতে এই message Send করুন।", orderName: "নাম", orderPhone: "ফোন", orderDeliveryArea: "ডেলিভারি এলাকা", orderDistrict: "জেলা", orderUpazila: "উপজেলা", orderAddress: "বিস্তারিত ঠিকানা", addressHelp: "গুরুত্বপূর্ণ: রাস্তা, বাসা, ফ্লোর বা পরিচিত জায়গা লিখুন। ডেলিভারি ম্যান এই ঠিকানা দিয়ে আপনাকে খুঁজবে।", orderNote: "নোট",

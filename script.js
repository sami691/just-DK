...
const text = {
  en: {
    ...
    policyTitle: "Return policy", policyText: "Please check the product in front of the delivery man. If it does not feel right, you can return it right away before the delivery man leaves.",
  ...
  bn: {
    ...
    policyTitle: "রিটার্ন পলিসি", policyText: "ডেলিভারি ম্যানের সামনে পণ্য দেখে নিন। পণ্য ভালো না লাগলে ডেলিভারি ম্যান যাওয়ার আগেই সাথে সাথে রিটার্ন করতে পারবেন।",
